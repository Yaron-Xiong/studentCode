 ...
 * <p>
 * 来源：力扣（LeetCode）
 * 链接：<a href="https://leetcode.cn/problems/earliest-finish-time-for-land-and-water-rides-i/description/?envType=daily-question&envId=2026-06-02">...</a>
 * 著作权归领扣网络所有。商业转载请联系官方授权，非商业转载请注明出处。
 */
public class L3633_EarliestFinishTime {
    public static void main(String[] args) {
        L3633_EarliestFinishTime l3633EarliestFinishTime = new L3633_EarliestFinishTime();
        System.out.println(l3633EarliestFinishTime.earliestFinishTime(new int[]{5}, new int[]{3}, new int[]{1}, new int[]{10}));
        System.out.println(l3633EarliestFinishTime.earliestFinishTime(new int[]{2, 8}, new int[]{4, 1}, new int[]{6}, new int[]{3}));
    }
