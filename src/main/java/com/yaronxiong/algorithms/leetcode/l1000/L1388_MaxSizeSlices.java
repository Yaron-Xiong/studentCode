 ...
 * <p>
 * 来源：力扣（LeetCode）
 * 链接：<a href="https://leetcode.cn/problems/pizza-with-3n-slices/">...</a>
 * 著作权归领扣网络所有。商业转载请联系官方授权，非商业转载请注明出处。
 */
public class L1388_MaxSizeSlices {
    public static void main(String[] args) {
        L1388_MaxSizeSlices l1388MaxSizeSlices = new L1388_MaxSizeSlices();
        System.out.println(l1388MaxSizeSlices.maxSizeSlices(new int[]{8, 9, 8, 6, 1, 1}));
    }
