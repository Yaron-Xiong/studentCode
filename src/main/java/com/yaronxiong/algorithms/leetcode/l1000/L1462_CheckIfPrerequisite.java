 ...
 * <p>
 * 来源：力扣（LeetCode）
 * 链接：<a href="https://leetcode.cn/problems/course-schedule-iv/description/?envType=daily-question&envId=2023-09-12">...</a>
 * 著作权归领扣网络所有。商业转载请联系官方授权，非商业转载请注明出处。
 */
public class L1462_CheckIfPrerequisite {
    public static void main(String[] args) {
        L1462_CheckIfPrerequisite l1462CheckIfPrerequisite = new L1462_CheckIfPrerequisite();
        System.out.println(l1462CheckIfPrerequisite.checkIfPrerequisite(33,
    ...
    public List<Boolean> checkIfPrerequisite(int numCourses, int[][] prerequisites, int[][] queries) {
        ...
        while (!deque.isEmpty()) {
            ...
            for (Integer neighbor : graph.get(node)) {
                f[node][neighbor] = true;
                for (int i = 0; i < numCourses; i++) {
                    f[i][neighbor] |= f[i][node];
                }
                ingress[neighbor]--;
