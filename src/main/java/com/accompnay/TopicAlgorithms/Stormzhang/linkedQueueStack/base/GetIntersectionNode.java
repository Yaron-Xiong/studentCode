package com.accompnay.TopicAlgorithms.Stormzhang.linkedQueueStack.base;
...
public class GetIntersectionNode {
	public static void main(String[] args) {
		...
		//root2.next.next = root.next;
		GetIntersectionNode getIntersectionNode = new GetIntersectionNode();
		ListNode intersectionNode = getIntersectionNode.getIntersectionNode(root, root2);
